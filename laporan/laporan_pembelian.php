<div class="row">
    <div class="col-lg-12">
        <h1 class="page-header"><i class="fa fa-book fa-fw"></i> Laporan Pembelian</h1>
    </div>
    <!-- /.col-lg-12 -->
</div>
...
if(isset($_POST['cari'])) {
    ...
    ?>
    <br>
    <a href="laporan/cetak2.php?mulai=<?php echo $mulai ?>&akhir=<?php echo $akhir ?>" class="btn btn-sm btn-primary" target="_blank"><i class="fa fa-print"></i> Cetak</a><br><br>
