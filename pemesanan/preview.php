...
if (isset($_POST['diproses'])) {
    ...
    if ($query) {
        echo "<script type='text/javascript'>alert('pesanan sedang diproses')</script>";
        echo "<meta http-equiv='refresh' content='1;url=index.php?page=beranda' >";
    }
    else {
        echo "<script type='text/javascript'>alert('permintaan belum diproses')</script>";
    }
}
*/
if (isset($_POST['add'])) {
...
<div class="row" style="margin-top: 25px;">
    <div class="col-lg-12" style="border-radius: 10px;box-shadow: 0 1px 8px 0 rgba(0,0,0.12);padding: 20px">
        ...
        <button class="btn btn-sm btn-danger btl" type="button" data-toggle="modal" data-target="#batal" data-btl="<?php echo $_GET['id']; ?>">BATAL</button>
        <?php }} else { ?>
        ...
        <a class="btn btn-sm btn-primary" href="javascript:window.print()">CETAK</a>
